...
//     struct elem* elem = plist->head.next;
//     list_remove(elem);
//     return elem;
// }
// //从链表查找元素obj—elem，成功则返回true，失败返回false
...
// }
// //把列表plist里的每个元素elem和arg传给回调函数func，arg给func用来判断elem是否符合条件。
// //其功能是遍历列表内的所有元素，逐个判断是否有符合条件的元素。找到符合条件的元素则返回元素指针，否则返回NULL
